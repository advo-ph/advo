...
const DotField = memo(({
  ...
  useEffect(() => {
    ...
    // The parent can change size without the window doing so — a route that renders a
    // spinner first and taller content after measures once, at spinner height, and would
    // otherwise keep painting dots into a band the size of the spinner.
